...
public class Constants {
    ...
    public static final String CART_POJO_SERIAL_KEY="com.store.pos.pojo.cart.CartPOJO";
    public static final String CART_LIST_POJO_SERIAL_KEY = "com.store.pos.pojo.cart.CartListPOJO";
